...
import (
	"github.com/aep-dev/terraform-provider-aep/pkg/terraformdocsgenerator/openapiterraformdocsgenerator"
	"log"
	"os"
)
...
func main() {
	...
	// https://github.com/aep-dev/terraform-provider-aep/blob/master/scripts/install.sh
